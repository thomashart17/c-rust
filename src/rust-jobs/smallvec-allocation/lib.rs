...
pub extern "C" fn entrypt() {
    ...
    match v {
        ...
        5 => test_drain(),
        6 => test_drain_panic(),
        7 => test_extend_from_slice(),
        8 => test_from_buf(),
        9 => test_from_buf_and_len(),
        10 => test_from_buf_and_len_unchecked(),
        11 => test_from_const(),
        12 => test_from_elem(),
        13 => test_from_raw_parts(),
        14 => test_from_slice(),
        15 => test_grow(),
        16 => test_insert(),
        17 => test_insert_from_slice(),
        18 => test_insert_many(),
        19 => test_insert_many_panic(),
        20 => test_new(),
        21 => test_new_const(),
        22 => test_pop(),
        23 => test_push(),
        24 => test_remove(),
        25 => test_reserve(),
        26 => test_reserve_exact(),
        27 => test_resize(),
        28 => test_resize2(),
        29 => test_resize_with(),
        30 => test_resize_with2(),
        31 => test_retain(),
        32 => test_retain_mut(),
        33 => test_set_len(),
        34 => test_shrink_to_fit(),
        35 => test_swap_remove(),
        36 => test_truncate(),
        37 => test_try_grow(),
        38 => test_try_reserve(),
        39 => test_try_reserve_exact(),
        40 => test_with_capacity(),
        _ => (),
    }
}
...
#[no_mangle]
fn test_insert_from_slice_panic() {
    const CAP: usize = 8;
